...
import { ListGroup,Button,Nav,NavDropdown,Form,FormControl } from 'react-bootstrap';
...
class Viewer extends Component {
  ...
  componentDidMount =  async ()  =>{
    ...
    setInterval(() => {
      socket.emit('requestLocations', this.state.username)
    }, 2000)
  }
