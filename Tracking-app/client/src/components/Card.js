                ...
                <td>
                    <div className='actions' style={{ marginBottom: 0 }}>
                        <div style={{ flexGrow: 1 }}>
                            <img className='crud' src="/images/square.png" onClick={(e) => this.setState({ Updatevisible: true })} style={{ marginBottom: 0 }} height="30" width="30"></img>

                        </div>
                        <div style={{ flexGrow: 1, marginRight: 15 }}>
                            <img className='crud' src="/images/button.png" onClick={(e) => this.setState({ Deletevisible: true })} style={{ marginBottom: 0 }} height="30" width="30"></img>
                        </div>
