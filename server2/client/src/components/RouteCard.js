...
class RouteCard extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/cards/getCoordinates/' + this.props.match.params.id,
      {
        headers: {
      ...
      .catch(
        this.setState({
          latlngOb: [{lat: 31.830153700000004,lng: -7.3157547}]
        })
      )
  }
  render() {
      ...
      <div>
        ...
        <div className="container">
          <Map className="map" center={position} zoom={this.state.zoom} >
            ...
            <AntPath positions={this.state.latlngOb} options={{ color: 'red', weight: 5, delay: 400 }} />
          </Map>
        </div>
...
export default connect(mapStateToProps, null)(RouteCard);
/*
import React, { Component } from 'react';
