       ...
       <Navbar></Navbar>
                <div className="flex-containerr">
                    ...
                    <Growl position='topleft' style={{marginTop:88}} ref={(el) => this.growl = el} />
                        <img alt='addCard' id="addButton" className='crud' src="/images/signs.png" height="50" width="50" onClick={(e) => this.setState({ visible: true })}></img>
                    </div>
                            ...
                            <tbody>
                                {
                                    this.props.cards.map((card,index) => {
                                        return (
                                            <Card key={index} card={card} updateCard={this.updateCard} deleteCard={this.deleteCard}></Card>
                                        )
                                    })
                                }
